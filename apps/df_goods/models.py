...
class GoodsInfo(models.Model):
    ...
    # gpic = models.ImageField(upload_to='', verbose_name="图片路径")
    gpic = models.ImageField(upload_to="df_goods/image/%Y/%m", verbose_name="图片路径", default="image/default.png", max_length=100, null=True, blank=True)
